...
<ResponseField name="all_upstream_blocks_executed" type="boolean">
  ...
  <ResponseField name="executor_config" type="object">
    Used when configuring a Kubernetes executor. See the [Kubernetes config](/production/configuring-production-settings/compute-resource#2-set-executor-type-and-customize-the-compute-resource-of-the-kozmo-executor) page for more details
  </ResponseField>
  <ResponseField name="executor_type" type="string">
    ...
    See the [Kubernetes config](/production/configuring-production-settings/compute-resource#2-set-executor-type-and-customize-the-compute-resource-of-the-kozmo-executor) page for more details.
  </ResponseField>
