...
3. Update Kozmo project settings
...
1. Open the Kozmo tool in your browser (e.g. http://localhost:6789/).
...
For `pipeline_run_url`, the default host is `http://localhost:6789`. You can specify `KOZMO_PUBLIC_HOST` to be
...
|                                                                                                        |
| ------------------------------------------------------------------------------------------------------ |
| ![Telegram](https://github.com/kozmoai/assets/blob/main/third-party/telegram-message-run-alert.jpg?raw=true) |
