...
Open the file named `io_config.yaml` at the root of your Kozmo project and enter the following:
...
Read these [instructions](https://github.com/kozmoai/kozmoai/blob/master/kozmo_integrations/kozmo_integrations/destinations/trino/README.md#run-trino-locally)
