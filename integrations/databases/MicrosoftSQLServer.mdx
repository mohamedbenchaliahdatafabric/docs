...
If you want to use other ODBC Driver versions, you'll need to build a custom docker image (use Kozmo image as the base image) and install the drivers.
...
from kozmo_ai.io.mssql import MSSQL
from os import path
