---
title: "Algolia Integration in Kozmo"
sidebarTitle: "Algolia Integration in Kozmo"
---

## Credentials Configuration

Open the file named `io_config.yaml` at the root of your Kozmo project and enter required fields:
