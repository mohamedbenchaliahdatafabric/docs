...
To effectively connect on a StrongDM Resource inside Kozmo's docker, you may need to add:
<br/>
...
To install StrongDM CLI tool, first access Kozmo's docker bash and execute the installation script:
```bash
