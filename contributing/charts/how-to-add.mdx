...
Add a new type in [`kozmo_ai/data_preparation/models/widget/constants.py`](https://github.com/kozmoai/kozmoai/blob/master/kozmo_ai/data_preparation/models/widget/constants.py):
...
Add a new type in [`kozmo_ai/frontend/interfaces/ChartBlockType.ts`](https://github.com/kozmoai/kozmoai/blob/master/kozmo_ai/frontend/interfaces/ChartBlockType.ts):
...
In the file `kozmo_ai/frontend/components/ChartBlock/constants.ts`,
...
file `kozmo_ai/frontend/interfaces/ChartBlockType.ts`,:
...
in the file `kozmo_ai/data_preparation/models/widget/constants.py`:
...
In the file `kozmo_ai/frontend/interfaces/ChartBlockType.ts`, add the following:
...
add the following information into the file `kozmo_ai/frontend/components/ChartBlock/constants.ts`:
...
In the file `kozmo_ai/data_preparation/models/widget/__init__.py`,
...
In the file `kozmo_ai/frontend/components/ChartBlock/ChartController.tsx`,
