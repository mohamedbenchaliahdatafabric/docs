...
description: "Making Kozmo invincible so that nothing can break it, not even itself."
icon: "swords"
---
...
[development environment](https://docs.kozmo.ai/contributing/development-environment).
- Make sure [user authentication](https://docs.kozmo.ai/production/authentication/overview) is enabled.
...
If you are running into issues with the app and would like to report it, you can tell us about it either on [GitHub](https://github.com/kozmoai/kozmoai/issues/new/choose) or [Slack](https://www.kozmo.ai/chat).
