---
title: "File versioning in Kozmo"
sidebarTitle: "File versions"
description: "Kozmo can automatically keep track of previous versions of a file."
---

## Overview
Kozmo has file versioning built-in— that means you don't need to configure Git to roll-back changes or recover old file versions.
...
![File versions](https://github.com/kozmoai/assets/blob/main/notebook/file-versions/file-versions.jpg?raw=true)
...
<img src="https://github.com/kozmoai/assets/blob/main/notebook/file-versions/file-versions-v0.9.58.png?raw=true"/>
