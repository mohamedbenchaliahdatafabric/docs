...
1. Build a Kozmo docker image with Spark following the instructions given at
[Build Kozmo docker image with Spark environment](/integrations/spark-pyspark#1-build-kozmo-docker-image-with-spark-environment).

2. Run the following command in your terminal to start Kozmo using docker:
```bash
...
<img
  ...
  src="https://github.com/kozmoai/assets/blob/main/pyspark-scratchpad-results.png?raw=True"
/>

4. Click the `Terminal` icon on the right side of the Kozmo UI, and create a dbt
...
<img
  ...
  src="https://github.com/kozmoai/assets/blob/main/dbt-spark-testing-results.png?raw=True"
/>
