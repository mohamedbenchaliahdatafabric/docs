...
Kozmo allows users to reference variables specific to your
...
![dbt target](https://github.com/kozmoai/assets/blob/main/connection-profiles/dbt-target.png?raw=True)
