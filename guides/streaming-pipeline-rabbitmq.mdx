...
4. Click on the black button called "Publish Message". This message should be seen on both kozmoai and your opensearch index!
...
2. This message should be seen on both kozmoai and your OpenSearch index!
