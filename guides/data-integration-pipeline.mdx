...
You must run Kozmo using [Docker](/getting-started/setup#using-docker) because there are a lot of
...
1. Open Kozmo in your browser and click the **`[+ New pipeline]`** button.
