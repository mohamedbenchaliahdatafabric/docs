...
<img alt="requirements" src="https://github.com/kozmoai/assets/blob/main/requirements.png?raw=True" />
...
```bash Sample output
CONTAINER ID   IKOZMO       COMMAND                  CREATED         STATUS         PORTS     NAMES
214e1155f5c3   kozmo/data   "python kozmo_ai/comm…"   5 seconds ago   Up 2 seconds             kozmoai_server_run_6f8d367ac405
```

The container name in the above sample output is
`kozmoai_server_run_6f8d367ac405`.
...
![create new pipeline](https://github.com/kozmoai/assets/blob/main/create-new-pipeline.gif?raw=True)
...
![](https://github.com/kozmoai/assets/blob/main/scratchpad.gif?raw=True)
...
![load data](https://github.com/kozmoai/assets/blob/main/load-data.gif?raw=True)
...
if 'test' not in globals():
    from kozmo_ai.data_preparation.decorators import test
...
![Transform data](https://github.com/kozmoai/assets/blob/main/transform-data.gif?raw=True)
...
![Train model](https://github.com/kozmoai/assets/blob/main/train-model.gif?raw=True)
...
```bash pip
bash kozmo run demo_project titanic_survivors
```
...
![](https://github.com/kozmoai/assets/blob/main/execute-pipeline-button.png?raw=True)
