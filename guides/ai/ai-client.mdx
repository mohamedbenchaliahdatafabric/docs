...
[the capabilities of Kozmo AI](https://docs.kozmo.ai/guides/ai/overview), as detailed in the
Kozmo AI capabilities documentation. Currently, we offer support for OpenAI and Hugging Face,
...
#### Kozmo Project Setup
Within your Kozmo project's metadata YAML configuration, please include the subsequent "ai_config" section:
...
you can fully leverage Kozmo AI's capabilities, such as generating blocks
...
This is an [example PR](https://github.com/kozmoai/kozmoai/pull/3850).

### Create new AI config

Create a dedicated configuration to save the params required to connect to LLM in the [config.py](https://github.com/kozmoai/kozmoai/blob/92c372b24e08148863d799d9afcdd44483c11c89/kozmo_ai/orchestration/ai/config.py#L19).
...
Inherit the [AIClient interface](https://github.com/kozmoai/kozmoai/blob/master/kozmo_ai/ai/ai_client.py)
...
The last action to take is modifying the Setup function within "[kozmo_ai/ai/llm_pipeline_wizard.py](https://github.com/kozmoai/kozmoai/blob/92c372b24e08148863d799d9afcdd44483c11c89/kozmo_ai/ai/llm_pipeline_wizard.py#L195)"
