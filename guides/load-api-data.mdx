...
If you haven't created a Kozmo project before, follow the [setup guide](/getting-started/setup) before starting this tutorial.
...
<CodeGroup>
```bash Mac/Linux
git clone https://github.com/kozmoai/etl-demo kozmo-etl-demo \
&& cd kozmo-etl-demo \
...
<AccordionGroup>
    <Accordion title="1️⃣ Create a pipeline">
        Open the pipelines list page (`/pipelines`). This is the default page when navigating to Kozmo in your web browser. If you have Kozmo running, just click [here](https://localhost:6789/pipelines).
        ...
        <Frame>
            <img
                ...
                src="https://github.com/kozmoai/assets/blob/main/tutorials/etl/create-new-pipeline.gif?raw=true"
            />
        </Frame>
        ...
        * `Shift + Enter`
        ...
        After you run the block (⌘ + Enter), you'll see a sample of the data that was loaded.
            ...
            <Frame>
                <img
                    alt="Load data"
                    src="https://github.com/kozmoai/assets/blob/main/tutorials/etl/load-data.gif?raw=true"
                />
            </Frame>
    </Accordion>
    <Accordion title="3️⃣ Transform data">
        ...
        * Clean the column names to properly store in a PostgreSQL database.
        ...
        <Frame>
            <img
                alt="Transform data"
                src="https://github.com/kozmoai/assets/blob/main/tutorials/etl/transform-data.gif?raw=true"
            />
        </Frame>
    </Accordion>
    <Accordion title="4️⃣ Export data to DuckDB">
        ...
        <Frame>
            <img
                alt="Export data"
                src="https://github.com/kozmoai/assets/blob/main/tutorials/etl/export-data.gif?raw=true"
            />
        </Frame>
...
<img
    alt="Lightning kozmo"
    src="https://raw.githubusercontent.com/kozmoai/assets/af9fafa41d823fe8e710d54f86164bef4378f5c3/mascots/earth/casting.svg"
/>

If you have more questions or ideas, get real-time help in our live support
[Slack channel](https://www.kozmo.ai/chat).
