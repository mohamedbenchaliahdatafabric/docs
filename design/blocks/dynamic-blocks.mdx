...
<Frame>
    <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/jQZb3lrAb8w?si=VF28Os4XbinyVOi8"
...
<AccordionGroup>
    <Accordion title="Krichkorn Oparad" icon="block-brick-fire" iconType="duotone" defaultOpen>
        ...
        >
        > An alternative approach would be to use an API trigger (like the one provided by Kozmo AI) to receive POST requests for each file that needs to be securely copied. However, this method can be highly resource-intensive, particularly when dealing with thousands of pipeline runs.
        >
        ...
        >
        > <img src="https://yt3.googleusercontent.com/ytc/AIdro_kcyWKgnvWDUDD6iOcxByIKb4E4zXJGYlT52Mtorrljo98f=s176-c-k-c0x00ffffff-no-rj" />
    </Accordion>
</AccordionGroup>
