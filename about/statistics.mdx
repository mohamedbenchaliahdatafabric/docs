...
<Check>
    ...
    It’s <b>impossible</b> for Kozmo to know which statistics belongs to whom.
</Check>
...
By opting into sending usage statistics to [Kozmo](https://www.kozmo.ai/),
it’ll help the team and community of contributors learn what’s going wrong with the tool
...
This will help Kozmo count how many projects have been created.
...
When an application error occurs in Kozmo, the error type, error message, and offending line of code
will be included in the usage statistics.
This will help fix bugs and improve the developer experience.

### Platform

The operating system, release, version, etc of the machine that Kozmo is running on.
This information will help reproduce errors.

## 🤷‍♀️ How does this work?

Usage statistics are anonymously sent to Kozmo’s online server.
...
`help_improve_kozmo` with the value `true`.

Here is an example:

```yaml
project_uuid: 4279d28ab1f64644b1f2f4f779be7b7e
help_improve_kozmo: true
```

### Disable

To disable, change the value of `help_improve_kozmo` to `false`.

Here is an example:

```yaml
project_uuid: 4279d28ab1f64644b1f2f4f779be7b7e
help_improve_kozmo: false
```
