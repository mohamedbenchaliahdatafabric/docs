...
You may need to restart your Kozmo application for the environment variable to be updated and
...
1. Go the the Kozmo project settings and click on the navigation row labeled <b>Roles</b>.
1. On the roles list page, there is a button labeled <b>Create default roles and permissions</b>.
    ...
    Each role will have a set of permissions that match the Kozmo API policies that are normally
...
<Frame>
    ...
    <img
        alt="Roles"
        src="https://github.com/kozmoai/assets/blob/main/authentication/permissions/roles-detail.png?raw=true"
    />
    </p>
</Frame>
...
1. Go the the Kozmo project settings and click on the navigation row labeled <b>Permissions</b>.
...
1. Select an entity that these permissions will be applied to.
    An entity refers to a defined API endpoint that currently exists in the Kozmo application.
...
<Frame>
    ...
    <img
        alt="Permissions"
        src="https://github.com/kozmoai/assets/blob/main/authentication/permissions/permissions-detail.png?raw=true"
    />
    </p>
</Frame>
...
1. Go the the Kozmo project settings and click on the navigation row labeled <b>Users</b>.
...
<Frame>
    ...
    <img
        alt="Users"
        src="https://github.com/kozmoai/assets/blob/main/authentication/permissions/users-detail.png?raw=true"
    />
    </p>
</Frame>
