...
description: "Kozmo is designed and built to be cloud native."
---

We recommend running your development environment and production environment in
the cloud. Use Kozmo's maintained [Terraform scripts](https://github.com/kozmoai/kozmoai-terraform-templates)
to deploy to cloud.

You can manage your cloud development environment with Kozmo. Each developer on
your team can have access to their own Kozmo server with a unique IP.
...
Kozmo currently natively supports creating dev environments in these cloud providers:
...
<img src="https://github.com/kozmoai/assets/blob/main/multi-dev-cloud-env.jpg?raw=true" />
