...
description: "Use Kozmo in multiple workspaces in the cloud"
---

We recommend running your production environment in the cloud. Kozmo has a built in
...
| `KOZMO_DATABASE_CONNECTION_URL` | `postgresql+psycopg2://...` |

If you run into issues deploying your infrastructure, feel free to reach out in our
[Slack](https://www.kozmo.ai/chat).

Depending on your cloud environment, Kozmo may expect additional environment variables.
Kozmo currently natively supports creating workspaces in these cloud providers:
...
<Frame>
    <img
        ...
        src="https://github.com/kozmoai/assets/blob/main/production/workspaces/workspaces-users.png?raw=true"
    />
</Frame>
...
<Frame>
    <img
        alt="Workspaces users"
        src="https://github.com/kozmoai/assets/blob/main/production/workspaces/workspaces-user-management.png?raw=true"
    />
</Frame>
