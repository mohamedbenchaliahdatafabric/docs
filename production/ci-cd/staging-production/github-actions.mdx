...
13. Copy the contents from the GitHub Action YAML file for AWS at
    [templates/github_actions/build_and_deploy_to_aws_ecs_staging_production.yml](https://github.com/kozmoai/kozmoai/blob/master/templates/github_actions/build_and_deploy_to_aws_ecs_staging_production.yml),
...
| `ECS_STAGING_SERVICE`             | The name of your AWS ECS staging service.                                                                                                                                                                                                                                                     | `kozmo-production-cluster`            |
| `ECS_PRODUCTION_SERVICE`          | The name of your AWS ECS production service.                                                                                                                                                                                                                                                  | `kozmo-production-ecs-service`        |
