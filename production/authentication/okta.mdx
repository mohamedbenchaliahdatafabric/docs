...
sidebarTitle: "Okta"
description: "Enable signing in with Okta in Kozmo."
---
...
You will need to add Kozmo as an OAuth client in your Okta organization admin dashboard.
...
Make sure you select the "Authorization Code" grant flow, and add `http(s)://<your-kozmo-url>/oauth` as a Sign-in redirect URI.
...
You should now see the "Sign in with Okta" button when you start Kozmo and attempt to sign in.

<Frame>
    <img
        alt="Sign in with Okta"
        src="https://github.com/kozmoai/assets/blob/main/production/authentication/sign-in-with-okta.png?raw=true"
    />
</Frame>