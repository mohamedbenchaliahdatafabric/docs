...
sidebarTitle: "Google"
description: "Enable signing in with a Google account in Kozmo."
---
...
Kozmo will request access for the following scopes:
...
You will need to add Kozmo as an OAuth client in your Google Cloud Platform project.
...
You will also need to add `http(s)://<your-kozmo-url>/oauth` as an authorized redirect URI.

</Step>

<Step title="Set environment variables">

Set the following environment variables in your Kozmo setup.
...
You should now see the "Sign in with Google" button when you start Kozmo and attempt to sign in.

<Frame>
    <img
        alt="Sign in with Google"
        src="https://github.com/kozmoai/assets/blob/main/production/authentication/sign-in-with-google.png?raw=true"
    />
</Frame>