...
Deploy Kozmo to your cloud provider using Terraform.

Cloud providers currently supported with Kozmo Terraform scripts:
...
Clone Kozmo’s
[Terraform template repository](https://github.com/kozmoai/kozmoai-terraform-templates):

```bash
git clone https://github.com/kozmoai/kozmoai-terraform-templates.git
```
