...
Terraform will perform the following actions:
  ...
  + resource "google_cloud_run_service" "run_service" {
      ...
      + template {
          ...
          + spec {
              ...
              + containers {
                  + image = "region-docker.pkg.dev/project_id/repository_name/kozmoai"
  ...
  + resource "google_compute_backend_service" "backend" {
      ...
      + name                            = "kozmo-data-prep-backend"
      + port_name                       = "http"
      + project                         = (known after apply)
      + protocol                        = "HTTP"
      + security_policy                 = "kozmo-data-prep-security-policy"
      + self_link                       = (known after apply)
  ...
  + resource "google_compute_global_address" "ip" {
      ...
      + creation_timestamp = (known after apply)
      + id                 = (known after apply)
      + name               = "kozmo-data-prep-service-ip"
      + project            = (known after apply)
      + self_link          = (known after apply)
    }
  ...
  + resource "google_compute_security_policy" "policy" {
      + fingerprint = (known after apply)
      + id          = (known after apply)
      + name        = "kozmo-data-prep-security-policy"
      + project     = (known after apply)
      + self_link   = (known after apply)
  ...
  + resource "google_compute_target_http_proxy" "http_proxy" {
      + creation_timestamp = (known after apply)
      + id                 = (known after apply)
      + name               = "kozmo-data-prep-http-proxy"
      + project            = (known after apply)
  ...
  + resource "google_vpc_access_connector" "connector" {
      ...
      + max_throughput = 300
      + min_throughput = 200
      + name           = "kozmo-data-prep-connector"
      + network        = "default"
      + project        = (known after apply)
      + region         = "us-west2"
      + self_link      = (known after apply)
