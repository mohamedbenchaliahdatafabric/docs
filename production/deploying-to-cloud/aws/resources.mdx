...
Terraform will perform the following actions:
 ...
 <= data "aws_ecs_task_definition" "main" {
      ...
      + task_definition      = "kozmo-data-prep-task"
 ...
 <= data "template_file" "env_vars" {
  ...
  + resource "aws_alb" "application_load_balancer" {
      ...
      + name                                        = "kozmo-data-prep-production-alb"
      + preserve_host_header                        = false
      + security_groups                             = (known after apply)
      + subnets                                     = (known after apply)
      + tags                                        = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-alb"
        }
      + tags_all                                    = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-alb"
  ...
  + resource "aws_cloudwatch_log_group" "log-group" {
      + arn               = (known after apply)
      + id                = (known after apply)
      + name              = "kozmo-data-prep-production-logs"
      + name_prefix       = (known after apply)
      + retention_in_days = 0
      + skip_destroy      = false
      + tags              = {
          + "Application" = "kozmo-data-prep"
          + "Environment" = "production"
        }
      + tags_all          = {
          + "Application" = "kozmo-data-prep"
  ...
  + resource "aws_db_instance" "rds" {
      ...
      + id                                    = (known after apply)
      + identifier                            = "kozmo-data-prep-production-db"
  ...
  + resource "aws_db_subnet_group" "rds_subnet_group" {
      + arn                     = (known after apply)
      + description             = "kozmo-data-prep RDS subnet group"
      + id                      = (known after apply)
      + name                    = "kozmo-data-prep-production-rds-subnet-group"
      + name_prefix             = (known after apply)
  ...
  + resource "aws_ecs_cluster" "aws-ecs-cluster" {
      ...
      + id                 = (known after apply)
      + name               = "kozmo-data-prep-production-cluster"
      + tags               = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-ecs"
        }
      + tags_all           = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-ecs"
  ...
  + resource "aws_ecs_service" "aws-ecs-service" {
      ...
      + id                                 = (known after apply)
      + launch_type                        = "FARGATE"
      + name                               = "kozmo-data-prep-production-ecs-service"
      ...
      + load_balancer {
          + container_name   = "kozmo-data-prep-production-container"
          + container_port   = 6789
  ...
  + resource "aws_iam_role" "ecsTaskExecutionRole" {
      ...
      + name                  = "kozmo-data-prep-execution-task-role"
      + name_prefix           = (known after apply)
      + path                  = "/"
      + role_last_used        = (known after apply)
      + tags                  = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-iam-role"
        }
      + tags_all              = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-iam-role"
  ...
  + resource "aws_iam_role_policy_attachment" "ecsTaskExecutionRole_policy" {
      ...
      + role       = "kozmo-data-prep-execution-task-role"
    }
  ...
  + resource "aws_lb_target_group" "target_group" {
      ...
      + name                               = "kozmo-data-prep-production-tg"
      + port                               = 6789
  ...
  + resource "aws_route_table" "public" {
      ...
      + tags             = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-routing-table-public"
        }
      + tags_all         = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-routing-table-public"
  ...
  + resource "aws_security_group" "rds_sg" {
      + arn                    = (known after apply)
      + description            = "kozmo-data-prep RDS Security Group"
      + egress                 = [
          + {
              + cidr_blocks      = [
                  + "0.0.0.0/0",
      ...
      + name                   = "kozmo-data-prep-production-rds-sg"
      + name_prefix            = (known after apply)
      + owner_id               = (known after apply)
      + revoke_rules_on_delete = false
      + tags                   = {
  ...
  + resource "aws_security_group" "service_security_group" {
      ...
      + tags                   = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-service-sg"
        }
      + tags_all               = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-service-sg"
  ...
  + resource "aws_subnet" "private" {
      ...
      + tags                                           = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-private-subnet-1"
        }
      + tags_all                                       = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-private-subnet-1"
  ...
  + resource "aws_subnet" "private" {
      ...
      + tags                                           = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-private-subnet-2"
        }
      + tags_all                                       = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-private-subnet-2"
  ...
  + resource "aws_subnet" "public" {
      ...
      + tags                                           = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-public-subnet-1"
        }
      + tags_all                                       = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-public-subnet-1"
  ...
  + resource "aws_subnet" "public" {
      ...
      + tags                                           = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-public-subnet-2"
        }
      + tags_all                                       = {
          + "Environment" = "production"
          + "Name"        = "kozmo-data-prep-public-subnet-2"
