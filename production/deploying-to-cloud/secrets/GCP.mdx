...
1. Run Kozmo and mount the secrets as a volume in Docker.
...
1. Create a new `.env` file in your Kozmo project folder with the following values:
...
1. Run Kozmo using Docker and set the environment variable `GOOGLE_APPLICATION_CREDENTIALS`.
