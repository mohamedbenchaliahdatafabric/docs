...
If you are using the provided Kozmo IO libraries, you can mock the libraries in the following way:
...
class ExampleIOTest(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        """
        # import shutil
        # from kozmo_ai.settings.repo import get_variables_dir
    ...
    def test_pipeline_execution(self):
        ...
        with patch(
            'kozmo_ai.io.postgres.Postgres.with_config', return_value=postgres_mock
        ), patch('kozmo_ai.io.bigquery.BigQuery.with_config', return_value=bq_mock):
    ...
    def test_block_execution(self):
        ...
        with patch('kozmo_ai.io.bigquery.BigQuery.with_config', return_value=bq_mock):
            block1.execute_sync()
