...
<img
  alt="Python mecha"
  src="https://github.com/kozmoai/assets/blob/main/development/python-package.png?raw=true"
  width="250"
></img>
</p>
...
Kozmo's `run_app.sh` script automatically installs the requirements.txt under the `USER_CODE_PATH` before server starts.
